...
- Explanation and examples: For each style element identified, provide a clear and concise explanation of why it's important and how it should be applied. Include at least two examples demonstrating both correct and incorrect usage.
...
## Dev Style Guides I Like
- [The Official Kodeco Swift Style Guide](https://github.com/kodecocodes/swift-style-guide)

Notes:
- The Swift style guide is hosted on GitHub as a markdown page. The readme section includes:
  - An overview
  - A table of contents that interlinks each section
    - The interlinking looks like:
    - [Topic](#topic-lowercase)
- Shows the preferred method vs not preferred
  - Example:
